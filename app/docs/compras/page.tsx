    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Link href="/docs/compras/pedidos" className="group">
          ...
          <Link href="/docs/compras/cotizaciones" className="group">
          ...
          <Link href="/docs/compras/autorizaciones" className="group">
            <div className="h-full rounded-2xl border-2 border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#4db8a8] hover:shadow-md">
              <div className="mb-4 text-4xl">✅</div>
              <h4 className="mb-3 text-lg font-semibold text-[#2d2d2d] group-hover:text-[#4db8a8]">
                Autorizaciones
          ...
          <Link href="/docs/compras/ordenes-de-compra" className="group">
            <div className="h-full rounded-2xl border-2 border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#4db8a8] hover:shadow-md">
              <div className="mb-4 text-4xl">📋</div>
              <h4 className="mb-3 text-lg font-semibold text-[#2d2d2d] group-hover:text-[#4db8a8]">
                Órdenes de compra
