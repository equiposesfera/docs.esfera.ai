export default function Paso2Page() {
  const step = {
    id: "paso-2",
    title: "Paso 2 · Crea tu empresa",
    description:
      "Centraliza la informacion fiscal y operativa de tu equipo en un solo lugar.",
    bullets: [
      "Define razon social y rubro",
      "Agrega metodos de contacto",
      "Configura logo y colores",
    ],
  };
