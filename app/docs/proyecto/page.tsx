export default function Paso3Page() {
  const step = {
    id: "paso-3",
    title: "Paso 3 · Crea tu proyecto",
    description:
      "Organiza objetivos, etapas y responsables para que todos trabajen alineados.",
    bullets: [
      "Selecciona plantilla o empieza en blanco",
      "Define fechas clave y metas",
      "Asigna lider de proyecto",
    ],
  };
